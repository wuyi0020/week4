    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4" v-for="(item) in products" :key="item.id">
                <ProductCoin :item=item :getcoinData=getcoinData />
            </div>
...
import ProductCoin from '../components/ProductCoin.vue';
import ProductCoinAdd from '../components/ProductCoinAdd.vue';
